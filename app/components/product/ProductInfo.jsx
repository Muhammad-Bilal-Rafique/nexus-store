  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-between items-center">
        <span className="inline-flex items-center w-fit px-3 py-1 rounded-full bg-action text-black text-xs font-bold uppercase tracking-widest border border-action">
          {product.category}
        </span>
      ...
      {product.sizes?.length > 0 && (
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center gap-1 text-xs font-bold text-text-primary hover:text-action transition">
      ...
      {/* Quantity */}
      <div className="mb-6">
        <p className="text-xs font-black uppercase tracking-widest text-text-primary mb-3.5">
          Quantity
        </p>
      ...
      {/* ADDED: Trust Badge */}
      <div className="flex justify-center gap-4 text-[10px] font-bold uppercase tracking-widest text-text-primary mt-2">
